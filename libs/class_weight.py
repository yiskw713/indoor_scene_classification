...
def get_class_num(train_csv_file: str, n_classes: int = len(get_cls2id_map())) -> torch.Tensor:
    """
...
def get_class_weight(train_csv_file: str, n_classes=len(get_cls2id_map())) -> torch.Tensor:
    """
